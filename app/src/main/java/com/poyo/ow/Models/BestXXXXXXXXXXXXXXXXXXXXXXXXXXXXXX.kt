...
data class BestXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX(
    val allDamageDoneMostInGame: Int,
    val allDamageDoneMostInLife: Int,
    val barrierDamageDoneMostInGame: Int,
    val criticalHitsMostInGame: Int,
    val criticalHitsMostInLife: Int,
    val eliminationsMostInGame: Int,
    val eliminationsMostInLife: Int,
    val finalBlowsMostInGame: Int,
    val heroDamageDoneMostInGame: Int,
    val heroDamageDoneMostInLife: Int,
